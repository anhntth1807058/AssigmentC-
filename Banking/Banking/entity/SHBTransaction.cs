...
namespace Banking.entity
{
    public class SHBTransaction
    {
        ...
        public SHBTransaction(string transactionId, TransactionType type, string senderAccountNumber,
            string receiverAccountNumber, decimal amount, string message, long createdAtMls, long updatedAtMls,
